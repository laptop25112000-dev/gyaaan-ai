    ...
    def complete(
        ...
        *,
        ...
        if role == "reasoner":
            ...
            content = (
                "Compare the collected sources using explicit criteria. "
                "Look for repeated recommendations, useful differences, and gaps. "
                f"Evidence available: {source_count} sources."
            )
        elif role == "critic":
            content = (
                "Challenge the leading conclusions. Identify conflicting claims, "
                "outdated evidence, commercial bias, and unsupported recommendations."
            )
        else:
